...
const IMAGES = {
  mining:       'https://images.unsplash.com/photo-1578496479763-c21ef8a43d50?w=1600&q=80&fit=crop',
  partnership:  'https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=800&q=80&fit=crop',
  esg:          'https://images.unsplash.com/photo-1473448912268-2022ce9509d8?w=800&q=80&fit=crop',
  agriculture:  'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80&fit=crop',
  people:       'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&q=80&fit=crop',
...
const NEWS = [
  {
    ...
    excerpt: 'The expansion marks a significant milestone in our commitment to sustainable resource extraction across the continent, opening new corridors of opportunity for communities and investors alike.',
    body: 'This landmark decision positions Binova as the leading mining operator across the Central African corridor. With operations set to double within 18 months, the company will deploy next-generation extraction technology…',
    featured: true,
    readTime: '4 min read',
    views: '2.4k',
    tag: 'Mining',
  ...
  },
  {
    ...
    author: { name: 'Marc Etienne', role: 'Finance Director' },
  },
  {
    id: 3,
    ...
    tag: 'ESG',
    image: IMAGES.esg,
    author: { name: 'Aline Mbarga', role: 'ESG Lead' },
  },
  {
    id: 4,
    ...
    author: { name: 'Jean-Paul Fotso', role: 'Innovation Lead' },
  },
  {
    id: 5,
...
const CAT_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  'Partnership':   { bg: '#D4AF37', text: '#FFFFFF' },
  'Report':        { bg: '#1a8a4c', text: '#FFFFFF' },
  'Innovation':    { bg: '#2a9d5f', text: '#FFFFFF' },
