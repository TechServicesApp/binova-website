...
const JOB_OPENINGS: JobOpening[] = [
  ...
  },
  {
    ...
    type: 'Full-time',
    color: '#1a8a4c',
    description: 'We are looking for competent Construction Workers to work on buildings, roads and other construction projects. You will help the plans of architects and engineers come to life and become full and solid structures. Experience in working on relevant projects and using equipment is essential. You must have physical strength, endurance and work well with your hands. Being good in collaboration and following instructions and safety rules are also important.',
    requirements: [
      ...
      'Very good knowledge of English or French (spoken and written).',
