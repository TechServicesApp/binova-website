...
export const TEAM_MEMBERS = [
  { firstName: 'Rev. Fabien', lastName: 'SADJOUGUET', position: 'President and Cofounder, Head of Science and Health Department', department: 'Executive', image: '/teams/membre4.png' },
  { firstName: 'Ferdinand', lastName: 'TEMWA', position: 'Head of Energy Department', department: 'Energy', image: '/teams/membre2.png' },
  { firstName: 'Head', lastName: 'Mining', position: 'Head of Mining Department', department: 'Mining', image: undefined },
  { firstName: 'Public', lastName: 'Works', position: 'Head of Public Work Department', department: 'Operations', image: undefined },
  { firstName: 'Marketing', lastName: 'Director', position: 'Head of Marketing and Strategy Department', department: 'Marketing', image: undefined },
  { firstName: 'Education', lastName: 'Head', position: 'Head of Education and Training Department', department: 'Strategy', image: undefined },
  { firstName: 'Textile', lastName: 'Director', position: 'Head of Textile, Plastic and Paper Department', department: 'Operations', image: undefined },
  { firstName: 'Banking', lastName: 'Director', position: 'Head of Banking and Finance Department', department: 'Finance', image: undefined },
  { firstName: 'Audit', lastName: 'Director', position: 'Head of Audit and Accounting Department', department: 'Finance', image: undefined },
  { firstName: 'Foods', lastName: 'Director', position: 'Head of Foods and Beverages Department', department: 'Operations', image: undefined },
  { firstName: 'Automotive', lastName: 'Director', position: 'Head of Automotive and Aerospace Department', department: 'Engineering', image: undefined },
  { firstName: 'Human', lastName: 'Resources', position: 'Head of Human Resources Department', department: 'Operations', image: undefined },
  { firstName: 'Electronics', lastName: 'Director', position: 'Head of Electronics Department', department: 'Technology', image: undefined },
  { firstName: 'Telecom', lastName: 'Director', position: 'Head of Telecom and Media Department', department: 'Communications', image: undefined },
  { firstName: 'Agriculture', lastName: 'Director', position: 'Head of Agriculture and Livestock Department', department: 'Agriculture', image: undefined },
  { firstName: 'Logistics', lastName: 'Director', position: 'Head of Logistics and Transportation Department', department: 'Operations', image: undefined },
  { firstName: 'Supermarkets', lastName: 'Director', position: 'Head of Supermarkets and Stores', department: 'Operations', image: undefined },
  { firstName: 'Romaric', lastName: 'TENDA', position: 'Press Relations and Media Partnership Consultant (CEO of G&J Media)', department: 'Communications', image: '/teams/membre3.png' },
  { firstName: 'Gislain', lastName: 'FONGANG', position: 'Civil and Architect Engineer (CEO of Mimschack Building)', department: 'Engineering', image: '/teams/membre1.png' },
  { firstName: 'Pharmaceutical', lastName: 'Engineer', position: 'Pharmaceutical Engineering Consultant (CEO of Pharmadeep)', department: 'Health', image: undefined },
] as const
...
export const OFFICES = [
  ...
  },
  {
    ...
    email: 'contact@binova-holding.cm',
    phone: '(237)677151188',
  },
] as const
