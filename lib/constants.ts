...
export const TEAM_MEMBERS = [
  { firstName: 'Rev. Fabien', lastName: 'SADJOUGUET', position: 'President and Cofounder, Head of Science and Health Department', department: 'Executive', image: '/teams/membre4.png', announced: true },
