...
export const PARTNERS = [
  {
    ...
    lastName: 'TENDA',
    company: 'G&J Media',
    logo: '/partners/gj-media.webp',
    position: 'Press Relations and Media Partnership Consultant',
    role: 'CEO',
    category: 'Media & Communications',
    image: '/teams/membre3.png',
    description: 'Leading media partnerships and press relations expertise',
    email: 'contact@gjmedia.com',
    phone: '+237xxxxxxxx',
    specialization: 'Communications',
  },
  {
    id: 2,
    firstName: 'Rev. Ghislain',
    lastName: 'FONGANG',
    company: 'Mimschack Building Company',
    logo: '/partners/architect.png',
    position: 'Civil and Architect Engineer Consultants',
    role: 'CEO',
    category: 'Engineering & Construction',
    image: '/teams/membre1.png',
    description: 'Expert in civil engineering and architectural solutions',
    email: 'contact@mimschack.com',
    phone: '+237xxxxxxxx',
  ...
  },
  {
    ...
    firstName: 'Pradip',
    lastName: 'BHALERAO',
    company: 'Pharmadeep Turnkey Consultants & Engineers Pvt. Ltd',
    logo: '/partners/pharmadeep.webp',
