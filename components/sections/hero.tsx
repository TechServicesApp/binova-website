...
const SLIDES = [
  {
    ...
    description: "An international group connecting North America to Central Africa, investing in 15+ sectors for sustainable growth and excellence-driven projects.",
    accent: "#135B34",
    index: "01",
  },
  {
  ...
  },
  {
    ...
    category: "Excellence",
    title: "50+ Experts",
    subtitle: "2 Continents · 15+ Sectors",
